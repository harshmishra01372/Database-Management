...
SELECT MONTHNAME('2025-11-20');      -- Extract month name
...
SELECT sale_id, product, year(sale_date) AS sale_year
FROM products;

-- Extract month from sale_date
SELECT sale_id, product, MONTH(sale_date) AS sale_month
FROM products;

-- Extract day from sale_date
SELECT sale_id, product, DAY(sale_date) AS sale_day
FROM products;
